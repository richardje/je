...
.*?<div class="caption">Version</div><div class="data">(?P<version>.*?)(?: <i>\(last update on (?P<last_update>.*?)\)</i>)?.*?<div class="rating"><span property="v:average" style="color:green; font-size: 20px;">(?P<rating>.*?)</span>.*?from <span property="v:count">(?P<rating_user>.*?)</span> users\.</div></div><div class="caption">Compatibility</div><div class="data">(?:<span><img[^>]* alt="(?P<compat_15>Joomla\! 1\.5 Native)"[^>]*></span>)?(?:<span><img[^>]* alt="(?P<compat_25>Joomla\! 2\.5 Series)"[^>]*></span>)?.*?</div><div class="caption ccol2">Votes</div><div class="data dcol2">.*?
